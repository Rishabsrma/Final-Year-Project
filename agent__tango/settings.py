"""
Django settings for agent__tango project.
...
ROOT_URLCONF = 'agent__tango.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'multiple_users.context_processors.get_notification',
            ],
        },
    },
]

WSGI_APPLICATION = 'agent__tango.wsgi.application'
